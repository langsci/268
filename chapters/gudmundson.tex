...
The structure of the introductory part of this paper is as follows: In \sectref{sec:gudmundson:1.1} and \ref{sec:gudmundson:1.2}, a presentation of the mental lexicon, both in L2 and in L3 is given. In \sectref{sec:gudmundson:1.3}, long-term cross-language semantic priming is discussed, while \sectref{sec:gudmundson:1.4} gives an outline of the functioning of word association studies. Finally, in \ref{sec:gudmundson:1.5}, the different types of word relations identified by \citet{FitzpatrickIzura2011} are presented.
...
\begin{table}
    ...
    \lsptoprule
        ~  &   \multicolumn{3}{c}{ Swedish} & \multicolumn{3}{c}{ English} & \multicolumn{3}{c}{ Italian} & \multicolumn{2}{c}{ Tot.}\\
    ...
    \caption{Association distribution, number of observations and standardized residuals for the different association categories and languages.}
    \label{tab:gudmundson:2}
\end{table}
...
\addplot[thick,draw=lsDarkWine , dashed,         nodes near coords]  table[x index=0,y index=1] \dataset; %ano de 2013-2014
\addplot[thick,draw=lsLightBlue, dotted, nodes near coords] table[x index=0,y index=2] \dataset; %ano de 2012-2013
\addplot[thick,draw=lsMidGreen , dash dot, nodes near coords]  table[x index=0,y index=3] \dataset; %ano de 2011-2012
\legend{L1 Swedish,L2 English,L3 Italian}
\end{axis}
\end{tikzpicture}
...
\begin{table}
    ...
    \lsptoprule
        ~ &   \multicolumn{3}{c}{ Swedish} & \multicolumn{3}{c}{ English} & \multicolumn{3}{c}{ Italian} & \multicolumn{3}{c}{ Tot.}\\
        Ass.      & Obs.              & \textit{M}    &             & Obs.               & \textit{M}    &             & Obs.              & \textit{M}    & \textit{SD} & Obs.              & \textit{M}    &            \\
             cat. &      (\textit{N}) &            RT & \textit{SD} &       \textit{N})  &            RT & \textit{SD} &      (\textit{N}) &            RT & \textit{SD} &      (\textit{N}) &            RT & \textit{SD}\\
    \midrule
    ...
    \caption{Mean reaction times and number of observations for the different association categories and languages.}
