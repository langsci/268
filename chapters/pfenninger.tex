...
\lsptoprule
&  & \multicolumn{2}{c}{\textsc{Mono}} & \multicolumn{2}{c}{\textsc{SimBi1}}  & \multicolumn{2}{c}{\textsc{SimBi2}}  & \multicolumn{2}{c}{\textsc{SeqBi}}  \\
...
\midrule
 1 & Listening comprehension & n.a. & n.a. & n.a. & n.a. & n.a. & n.a. & n.a. & n.a.\\
 \tablevspace
 2 & Productive  vocabulary & n.a. & n.a. & n.a. & n.a. & n.a. & n.a. & n.a. & n.a.\\
 \tablevspace
...
\lsptoprule
&  & \multicolumn{2}{c}{\textsc{Mono}} & \multicolumn{2}{c}{\textsc{SimBi1}}  & \multicolumn{2}{c}{\textsc{SimBi2}}  & \multicolumn{2}{c}{\textsc{SeqBi}}  \\
& & \textsc{ECL}\textsc{\textsubscript{2}} (n=100) &  \textsc{LCL}\textsc{\textsubscript{2}}  (n=100) & \textsc{ECL}\textsc{\textsubscript{2}}  (n=73) & \textsc{LCL}\textsc{\textsubscript{2}} (n=71) & \textsc{ECL}\textsc{\textsubscript{2}} (n=57) & \textsc{LCL}\textsc{\textsubscript{2}} (n=50) & \textsc{ECL}\textsc{\textsubscript{2}} (n=95) & \textsc{LCL}\textsc{\textsubscript{2}} (n=90)\\
\midrule
 ...
 6 & Written lexical richness & { 7.57}
...
L1 literacy skills were clearly positively related to L2 literacy skills in all groups, predicting written content, organization, lexical richness, fluency and complexity, as Figures \figref{fig:pfenninger:7} and \figref{fig:pfenninger:8} illustrate for written fluency scores (see also \citealt{Pfenninger2014}).
...
\begin{sidewaystable}
\caption{\label{tab:pfenninger:12} Descriptive statistics (means and standard deviations) for German literacy at Time 1.}
...
\lsptoprule
 ...
 & \textsc{ECL}\textsc{\textsubscript{1}} (n=100) &  \textsc{LCL}\textsc{\textsubscript{1}}  (n=100) & \textsc{ECL}\textsc{\textsubscript{1}}  (n=73) & \textsc{LCL}\textsc{\textsubscript{1}} (n=71) & \textsc{ECL}\textsc{\textsubscript{1}} (n=57) & \textsc{LCL}\textsc{\textsubscript{1}} (n=50) & \textsc{ECL}\textsc{\textsubscript{1}} (n=95) & \textsc{LCL}\textsc{\textsubscript{1}} (n=90)\\
\midrule
 Written content \newline (German) & { 23.17} (2.77) & { 24.65} (2.16) & { 24.82} (3.43) & { 25.93} (3.10) & { 23.63} (2.68) & { 24.48} (2.57) & { 21.27} (3.82) & { 22.82} (4.52)\\
 \tablevspace
  Written organization \newline (German) & { 13.98} (2.97) & { 15.96} (2.72) & { 14.08} (2.78) & { 14.75} (3.24) & { 14.30} (3.34) & { 16.34} (2.82) & { 14.55} (3.36) & { 15.77} (2.63)\\
   \tablevspace
  Written lexical \newline richness (German) & { 7.24} (1.28) & { 7.90} (1.30) & { 7.30} (1.53) & { 7.92} (1.38) & { 7.54} (1.33) & { 8.24} (1.19) & { 7.31} (1.58) & { 7.72} (1.32)\\
   \tablevspace
 Written fluency \newline (German) & { 13.08} (3.23) & { 15.20} (4.17) & { 15.49} (3.17) & { 16.83} (4.00) & { 13.47} (4.26) & { 15.56} (4.97) & { 11.58} (4.26) & { 13.72} (5.41)\\
  \tablevspace
...
\todo{potential error in numbering of table 8/9, first column?}
...
\begin{table}
	\caption{\label{tab:pfenninger:15} Multilevel regression analyses for environmental influences at Time 1 (fixed effect estimates for home variables) (continued from \tabref{tab:pfenninger:14}).}
