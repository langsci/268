...
\label{tab:munoz:1}
\fittable{
\begin{tabular}{p{2.2cm}rrrrrrrrrr}
\lsptoprule
& \multicolumn{2}{c}{ PPVT} & \multicolumn{2}{c}{ CRI} & \multicolumn{2}{c}{ NCRI} & \multicolumn{2}{c}{{ {EFL Hours}}} & \multicolumn{2}{c}{ EFL+CLIL Hours}\\

Group & {\itshape M} & {\itshape SD} & {\itshape M} & {\itshape SD} & {\itshape M} & {\itshape SD} & {\itshape M} & {\itshape SD} & {\itshape M} & {\itshape SD}\\
\midrule
{{7 yrs/Grade 2}}\newline
{ ({\textit{N}} {= 77)}} & 30.08 & 17.67 & .64 & .17 & .49 & .08 & { {281.92}} & 123.25 & { 385.94} & 175.27\\
{ {9 yrs/Grade 4}}\newline
{ ({\textit{N}} {= 93)}} & 59.03 & 28.43 & .74 & .11 & .55 & .07 & 525.21 & 138.82 & 858.02 & 299.01\\
\lspbottomrule
...
\lspbottomrule
\end{tabularx}
\flushleft{\textsuperscript{a}}{Age 7/Grade 2 is the reference group}
\end{table}

 {A similar analysis was conducted to assess the role of age and contact hours on these children’s recognition of non-cognate words. As displayed in \tabref{tab:munoz:3}, age was not a significant predictor of non-cognate word recognition, but there was a main effect of total hours of contact (}{\textit{p}} {< .01). In other words, the higher the amount of contact hours with English, the more non-cognate words were known (although the increase that an average child would experience for every 1 extra hour is extremely small).}
