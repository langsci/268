...
The rest of the section summarises the results from a quantitative perspective. \tabref{tab:sanchez7:5} presents the decriptive statistics of the occurrence of ILST in the L3 at different levels of L2SP (raw frequency of occurrence, mean and standard deviation) in each structural property in the L2. A close inspection of the means reveals that ILST consistently occurred more frequently in low than in high levels of L2SP, and this is true regardless of the L2 structural property examined.
